<div class="form-field">
    ...
    <div>
        ...
        <label for="full_name"><?php _e( 'Full Name', 'lithe' ); ?></label>
...
<div class="form-field">
    ...
    <div>
        ...
        <label for="dob"><?php _e( 'Birthday', 'lithe' ); ?></label>
...
<div class="form-field">
    <div>
        ...
        <label for="gender"><?php _e( 'Gender', 'lithe' ); ?></label>
...
<div class="form-field">
    ...
    <div>
        ...
        <label for="breed"><?php _e( 'Breed', 'lithe' ); ?></label>
    ...
    <select name="breed">
        ...
        <?php foreach ( $breeds as $breed ): ?>
            ...
            <option value="<?php echo esc_attr( $breed->term_id ); ?>" <?php selected( $breed_id, $breed->term_id ); ?>><?php echo $breed->name; ?></option>
...
<div class="form-field">
    ...
    <div>
        ...
        <label for="pedigree_no"><?php _e( 'Pedigree No', 'lithe' ); ?></label>
...
<div class="form-field">
    ...
    <div>
        ...
        <label for="tattoo"><?php _e( 'Tattoo No', 'lithe' ); ?></label>
...
<div class="form-field">
    ...
    <div>
        <label for="microchip_no"><?php _e( 'Microchip No', 'lithe' ); ?></label>
    </div>
...
<div class="form-field">
    ...
    <div>
        ...
        <label for="workbook_no"><?php _e( 'Workbook No', 'lithe' ); ?></label>
...
<div class="form-field">
    ...
    <div>
        ...
        <label for="height"><?php _e( 'Height', 'lithe' ); ?></label>
